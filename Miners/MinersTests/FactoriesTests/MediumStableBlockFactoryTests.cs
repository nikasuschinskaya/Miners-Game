...
{
    [TestClass]
    public class MediumStableBlockFactoryTests
    {
        ...
        {
            _texturePath = ConfigurationManager.AppSettings["textureMediumStableBlockPath"];
            _x = 0;
            _y = 0;
        }

        [TestMethod]
        public void CreateObject_ReturnsInstanceOfMediumStableBlock()
        {
            // Arrange
            var factory = new MediumStableBlockFactory(_x, _y);

            // Act
            var block = factory.CreateObject();

            // Assert
            Assert.IsInstanceOfType(block, typeof(MediumStableBlock));
        }
        ...
        public void CreateObject_SetsCorrectPositionAndTexturePath()
        {
            ...
            var block = (MediumStableBlock)result;
